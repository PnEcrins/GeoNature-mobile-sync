...
public class DeviceSettings
{
	...
	public DeviceSettings(String manufacturer, String model, String name, AndroidSettings androidSettings)
	{
		super();
	...
	public DeviceSettings(JSONObject json) throws JSONException
	{
	...
	public int hashCode()
	{
		...
		int result = 1;
		result = prime * result
				+ ((androidSettings == null) ? 0 : androidSettings.hashCode());
		result = prime * result
