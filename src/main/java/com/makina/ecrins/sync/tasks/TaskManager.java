        ...
        implements Observer
{
    ...
    private TaskManager()
    {
        ...
        this.tempDir = new File(
                ...
                "sync_data_" + Long.toString(System.currentTimeMillis())
        );
        this.tempDir.mkdir();
        ...
        {
            LOG.warn(
                    "unable to delete '" + this.tempDir.getAbsolutePath() + "'",
                    ioe
            );
        }
                       ...
                       Object arg)
    {
        ...
        {
            switch (((AbstractTaskRunnable) o).getTaskStatus()
                    .getStatus())
            {
                case FINISH:
                    synchronized (tasks)
                        ...
                        if (currentStatus.equals(Status.FINISH))
                        {
                            ...
                            LOG.info(
                                    ResourceBundle.getBundle("messages")
                                            .getString("MainWindow.status.finish")
                            );
                        }
                    }
                    ...
                    break;
                default:
                    this.status = ((AbstractTaskRunnable) o).getTaskStatus()
                            .getStatus();
            }
        }
    }
