 ...
 */
public class ServerStatusWidget
        implements Observer
{
    ...
    private void createContents()
    {
        ...
        fd_canvasServerStatus.left = new FormAttachment(
                parent,
                10
        );
        fd_canvasServerStatus.top = new FormAttachment(
                parent,
                37
        );
        ...
        canvasServerStatus.addPaintListener(
                new PaintListener()
                {
        ...
        fdLabelServer.top = new FormAttachment(
                canvasServerStatus,
                5,
                SWT.TOP
        );
        fdLabelServer.left = new FormAttachment(
                canvasServerStatus,
                5
        );
        ...
        labelServer.setText(
                ResourceBundle.getBundle("messages")
                        .getString("MainWindow.labelServer.text")
        );

        labelServerSeparator = new Label(
                parent,
                SWT.NONE
        );
        FormData fdlabelServerSeparator = new FormData();
        fdlabelServerSeparator.top = new FormAttachment(
                canvasServerStatus,
                5,
                SWT.TOP
        );
        ...
        fd_labelServerStatus.top = new FormAttachment(
                canvasServerStatus,
                5,
                SWT.TOP
        );
        fd_labelServerStatus.left = new FormAttachment(
                labelServerSeparator,
                5
        );
                ...
                display.syncExec(
                        new Runnable()
                        {
                            ...
                            public void run()
                            {
                                ...
                                labelServerStatus.getParent()
                                        .layout();

                                switch (status)
                                {
                                    case PENDING:
                                        labelServer.setForeground(
                                        ...
                                        labelServerSeparator.setForeground(
                                                UIResourceManager.getColor(
                                                        218,
                                                        165,
                                                        32
                                        ...
                                        labelServerStatus.setForeground(
                                                UIResourceManager.getColor(
                                                        218,
                                                        165,
                                                        32
