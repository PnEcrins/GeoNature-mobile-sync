 ...
 */
public class ConsoleLogComposite
        extends Composite
        implements Observer
{
    ...
    private void initialize()
    {
        ...
        final ExpandBar expandBarLogs = new ExpandBar(
                this,
                SWT.NONE
        );
        ...
        expandBarLogs.addExpandListener(
                new ExpandListener()
                {
                    @Override
        ...
        expandItemLogs.setText(
                ResourceBundle.getBundle("messages")
                        .getString("MainWindow.expandItemLogs.text")
        );
        ...
        expandItemLogs.setHeight(
                expandItemLogs.getControl()
                        .computeSize(
                                SWT.DEFAULT,
                                SWT.DEFAULT
                        ).y
                                                                        ...
                                                                        getDisplay().getActiveShell()
                                                                                .setSize(
                                                                                        getDisplay().getActiveShell()
                                                                                                .getSize().x,
                                                                                        getDisplay().getActiveShell()
                                                                                                .getSize().y + expandItemLogs.getHeight() + 10
                                                                                );
                                                                    }
                                                                }
                                                        );
