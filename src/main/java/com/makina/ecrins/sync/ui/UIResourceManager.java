 ...
 * <p/>
 * !!! IMPORTANT !!! Application code must explicitly invoke the <code>dispose()</code> method
 * to release the operating system resources managed by cached objects when those objects and OS resources
...
public class UIResourceManager
{
     ...
     */
    protected static Image getImage(InputStream stream) throws
                                                        IOException
    {
        try
        {
        ...
        if (font == null)
        {
            ...
            if (strikeout || underline)
            {
                try
                {
                    ...
                    Object logFont = FontData.class.getField("data")
                            .get(fontData); //$NON-NLS-1$

                    if (logFont != null && logFontClass != null)
                    {
                        if (strikeout)
                        {
                            logFontClass.getField("lfStrikeOut")
                                    .set(
                                            logFont,
                                            Byte.valueOf((byte) 1)
                                    ); //$NON-NLS-1$
                        ...
                        if (underline)
                        {
                            logFontClass.getField("lfUnderline")
                                    .set(
                                            logFont,
                                            Byte.valueOf((byte) 1)
                                    ); //$NON-NLS-1$
