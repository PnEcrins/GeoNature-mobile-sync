	...
	public static Image getImage(String path)
	{
		...
		if (image == null)
		{
			try
			{
				...
				image = new Image(Display.getCurrent(), Thread.currentThread().getContextClassLoader().getResourceAsStream(path));
	...
	public static Font getFont(String name, int size, int style, boolean strikeout, boolean underline)
	{
		...
		if (font == null)
		{
			...
			if (strikeout || underline)
			{
				...
				{
					LOG.error("Unable to set underline or strikeout (probably on a non-Windows platform)" , t);
				}
			}
