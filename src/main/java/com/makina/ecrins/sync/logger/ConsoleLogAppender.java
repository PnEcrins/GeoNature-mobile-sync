 ...
 */
public class ConsoleLogAppender extends Observable implements Appender, OptionHandler
{
	private String name;
	...
	{
		setChanged();
		notifyObservers(new LogMessage(Action.RESET, "", Level.OFF));
	}
	...
	public void doAppend(LoggingEvent event)
	{
		...
		setChanged();
		notifyObservers(new LogMessage(Action.APPEND, this.layout.format(event), event.getLevel()));
	}
